...
function StoryViewer({ initialIndex, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-black/95 flex items-center justify-center backdrop-blur-md">
      ...
      {/* Main Container */}
      <div className="relative w-full max-w-[450px] h-full md:h-[90vh] overflow-hidden md:rounded-2xl bg-black flex flex-col items-center justify-center">
        {/* Progress Bars */}
...
export default function StorySection() {
  ...
  return (
    <div className="relative group mb-6 p-4">
      ...
      >
        <div className="relative shrink-0 w-28 h-44 md:w-32 md:h-52 rounded-xl overflow-hidden cursor-pointer bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm">
