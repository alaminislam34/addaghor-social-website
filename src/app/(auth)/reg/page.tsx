...
type InputProps = {
  ...
  required?: boolean;
  className?: string; // Added to handle full-width logic
};
...
const InputField = ({
  ...
  <div className={`flex flex-col gap-1.5 w-full ${className}`}>
    ...
    <input
      ...
      required={required}
      className="w-full py-2.5 px-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl 
...
function Register() {
  ...
  return (
    <section className="min-h-screen w-full flex justify-center items-center bg-light dark:bg-dark transition-colors duration-300 p-4 py-12 relative overflow-hidden">
